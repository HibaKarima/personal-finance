...
function RecurringBills() {
  return (
    <div className="flex flex-col gap-5 p-5 rounded-2xl bg-white shadow-sm">
      ...
      <div className="flex flex-col items-center gap-2 rounded-2xl">
        {billsData.slice(0, 3).map((item: billstItem, index: number) => (
          <div
            key={index}
            className="flex justify-between items-center rounded-xl border-s-5 bg-[#f8f4f0] p-5 w-full"
